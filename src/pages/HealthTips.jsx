...
const HealthTips = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-green-50 to-blue-50 px-6 md:px-20 py-16 flex flex-col items-center space-y-12">
            ...
            >
                Keeping your pet healthy is more than just food and play. Follow
                these tips to ensure your furry friend stays happy, active, and
                thriving!
            </motion.p>
            ...
            >
                ...
                <p className="text-gray-700 text-lg">
                    Regular exercise and mental stimulation can increase your
                    pet's lifespan and keep them mentally sharp!
                </p>
            </motion.div>
        </div>
    );
