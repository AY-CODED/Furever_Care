...
import { FaHeartbeat, FaPaw } from "react-icons/fa";
...
const HealthTips = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-indigo-50 to-blue-50 px-6 md:px-20 py-16 flex flex-col items-center space-y-12">
      {/* Back Button */}
      <button
        onClick={() => navigate(-1)}
      ...
      >
        Keeping your pet healthy is more than just food and play. Follow these
        tips to ensure your furry friend stays happy, active, and thriving!
      </motion.p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 w-full max-w-6xl">
        {tips.map((tip, index) => (
          <motion.div
            ...
            className="flex flex-col items-center justify-center p-6 rounded-3xl shadow-2xl bg-gradient-to-tr from-indigo-200 via-blue-200 to-cyan-200 hover:from-blue-300 hover:to-indigo-300 transition-all duration-500 cursor-pointer"
          >
      ...
      >
        ...
        <p className="text-gray-700 text-lg">
          Regular exercise and mental stimulation can increase your pet's
          lifespan and keep them mentally sharp!
        </p>
      </motion.div>
    </div>
  );
