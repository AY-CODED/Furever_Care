...
import { PawPrint, Stethoscope, Home } from "lucide-react"; // icons
...
const SignUp = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (!firstName || !password || !userType) {
        ...
        >
            ...
            >
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    {/* User Type (Cards instead of select) */}
                    {/* <div>
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {userOptions.map((option) => (
                <div
                  ...
                  className={`cursor-pointer p-4 rounded-xl border text-center transition transform hover:-translate-y-1 ${
